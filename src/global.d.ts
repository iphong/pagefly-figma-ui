...
// Mixins
	...
	interface DefaultShapeMixin extends BaseNodeMixin, SceneNodeMixin, ReactionMixin,
		BlendMixin, GeometryMixin, LayoutMixin, ExportMixin {
	}

	interface DefaultFrameMixin extends BaseNodeMixin, SceneNodeMixin, ReactionMixin,
